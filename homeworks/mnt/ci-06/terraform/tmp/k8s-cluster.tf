...
locals {
  ...
  folder_id             = "b1g3i641nh19u19bfr2q"            # Set your cloud folder ID.
  k8s_version           = "1.26"            # Set the Kubernetes version.
  sa_name               = "k8s-sa"            # Set a service account name. It must be unique in a cloud.
}
