...
6. [Скриптовые языки и языки разметки](#lang)  
  6.1 [Bash](#bash)  
---------------
...
<a name="lang"></a>
## 6. Скриптовые языки и языки разметки  
<a name="bash"></a>
#### Bash  
1.  
...
Решение: добавляем ограничение на максимальный размер файла и завершение работы при условии доступности сервиса
```
#!/bin/bash
